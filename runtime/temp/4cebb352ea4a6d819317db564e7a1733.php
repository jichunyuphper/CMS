<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\phpstudy\PHPTutorial\WWW\cms\public/../application/admin\view\conf\lst.htm";i:1543067910;s:69:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\top.htm";i:1552823536;s:70:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\left.htm";i:1553328364;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-body">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody id="row">
                            ...
                            <tr id="tr_<?php echo $conf['id']; ?>">
                                ...
                                <td align="center"><?php if($conf['values'] == ''): ?>未定义<?php else: ?><?php echo $conf['values']; endif; ?></td>
                                <td  align="center">
                                    ...
                                    <a confid="<?php echo $conf['id']; ?>" onclick="changedel(this);" class="btn btn-danger btn-sm shiny">
                ...
                <div><?php echo $ConfRes->render(); ?></div>
            </div>
        </div>
    </div>
</div>
