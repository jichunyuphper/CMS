<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\phpstudy\PHPTutorial\WWW\cms\public/../application/admin\view\auth_rule\edit.htm";i:1553257851;s:69:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\top.htm";i:1552823536;s:70:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\left.htm";i:1553328364;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('edit'); ?>" method="post">
						...
						<div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">上级规则：</label>
                            <div class="col-sm-6">
								<select name="pid">
									<option value="0">顶级规则</option>
										<?php if(is_array($ruleRes) || $ruleRes instanceof \think\Collection || $ruleRes instanceof \think\Paginator): $i = 0; $__LIST__ = $ruleRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Res): $mod = ($i % 2 );++$i;if(!in_array($Res['id'],$children)): ?>
									<option <?php if($edit['pid'] == $Res['id']): ?> selected="selected" <?php endif; ?> value="<?php echo $Res['id']; ?>">	<?php echo str_repeat("-----|  ",$Res['level']);?><?php echo $Res['title']; ?></option>
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">规则名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="title" value="<?php echo $edit['title']; ?>" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">规则：</label>
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="name" value="<?php echo $edit['name']; ?>" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

						<div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">图标样式：</label>
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" value="<?php echo $edit['icon']; ?>" name="icon"  type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 参考beyoundAdmin</p>
                        </div>

						<div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">是否开启：</label>
							<label>
                                <input <?php if($edit['status'] == 1): ?> checked="checked" <?php endif; ?> name="status" value="1" type="radio"  class="colored-blue">
                                <span class="text"> 是</span>
                            </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<label>
                                <input <?php if($edit['status'] == 0): ?> checked="checked" <?php endif; ?> type="radio" name="status" value="0" class="colored-danger">
                                <span class="text"> 否</span>
                            </label>
                        </div>

						<div class="form-group">
							<label for="username" class="col-sm-2 control-label no-padding-right">是否在左侧菜单显示：</label>
							<label>
								<input  <?php if($edit['show'] == 1): ?> checked="checked" <?php endif; ?> name="show" value="1" type="radio"  class="colored-blue">
								<span class="text"> 是</span>
							</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<label>
								<input <?php if($edit['show'] == 0): ?> checked="checked" <?php endif; ?> type="radio" name="show" value="0" class="colored-danger">
								<span class="text"> 否</span>
							</label>
						</div>
