<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpstudy\PHPTutorial\WWW\cms\public/../application/admin\view\advertisement\lst.htm";i:1556536991;s:69:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\top.htm";i:1552823536;s:70:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\left.htm";i:1553328364;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
	...
	<link href="/cms/public/static/admin/style/jquery-ui.min.css" rel="stylesheet">
...
<div  class="row">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody id="row"  class="sortable">
                            ...
                            <tr id="tr_<?php echo $lst['id']; ?>"   class="ui-state-default">

                                <td align="center"  width="6%" class="m_ttitle" style="cursor:move;background:#00FFFF;"><i style="float:left;cursor:move" class="fa fa-arrows-v"></i><?php echo $lst['id']; ?></td>
                                <td align="center"  width="18%"><?php echo $lst['name']; ?></td>
                                <td align="center" width="18%">
									<a href="javascript:;" staticid="<?php echo $lst['id']; ?>" adid="<?php echo $lst['adid']; ?>" onclick="updateAllStatic(this)" class="btn btn-success shiny">关闭其他广告</a>
								</td>
								<td align="center"  width="18%">
									<?php if($lst['bname']): ?>
										<?php echo $lst['bname']; else: ?>
										未选择广告位
									<?php endif; ?>
                                ...
                                <td align="center"  width="10%">
									...
									<label style="cursor:pointer;">
                                        <input adid="<?php echo $lst['adid']; ?>" staticid="<?php echo $lst['id']; ?>" static="<?php echo $lst['static']; ?>" oneid="<?php echo $lst['id']; ?>" class="checkbox-slider colored-blue" <?php if($lst['static'] == 1): ?> checked="checked" <?php endif; ?> onclick="UpdateStatic(this);" type="checkbox">
                                ...
                                <td  align="center"  width="12%">
                                    <a href="<?php echo url('edit',['id'=>$lst['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>

                                    <a confid="<?php echo $lst['id']; ?>" onclick="changedel(this);" class="btn btn-danger btn-sm shiny">
	...
	<script src="/cms/public/static/admin/style/jquery-ui.min.js"></script>
	...
	function UpdateStatic(o){
		...
		$.ajax({
			...
			dataType:"json",
			data:{id:id},
			url:"<?php echo url('Advertisement/updateStatic'); ?>",
			success:function(data){
	...
	function updateAllStatic(o){
		...
		$.ajax({
			...
			url:"<?php echo url('Advertisement/updateAllStatic'); ?>",
			success:function(data){
