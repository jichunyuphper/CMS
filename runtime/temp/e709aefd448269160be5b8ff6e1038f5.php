<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"D:\phpstudy\PHPTutorial\WWW\cms\public/../application/admin\view\conf\add.htm";i:1538405745;s:69:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\top.htm";i:1552823536;s:70:"D:\phpstudy\PHPTutorial\WWW\cms\application\admin\view\common\left.htm";i:1553328364;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('add'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="dt_type" style="width: 100%;">
                                    <option selected="selected" value="1">单行文本</option>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="cf_type" style="width: 100%;">
                                    <option selected="selected" value="1">站点基本配置</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" id="value" placeholder="" name="value" ></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">默认为第一个可选值</p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" id="values" placeholder="" name="values" ></textarea>
                            </div>
                             <p class="help-block col-sm-4 red">可选值之间以，或空格分隔</p>
                        </div>
