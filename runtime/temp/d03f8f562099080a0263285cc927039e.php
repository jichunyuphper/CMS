<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpstudy\PHPTutorial\WWW\cms\public/../application/install\view\index\step3.htm";i:1554036551;}*/ ?>
﻿<!DOCTYPE html>
<html><head>
...
<script type="text/javascript">
    ...
    function change(){     
      var a=document.getElementById("install_process");
        a.innerText="完成";
        a.href="<?php echo url('admin/Login/login'); ?>";
        alert("安装完成,初始账号:admin,密码:admin");
    }
</script>
